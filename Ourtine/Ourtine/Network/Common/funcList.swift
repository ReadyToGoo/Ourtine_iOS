...
//    wrapper.requestSuccessRes(target: .patchInterestingCategories(categories: ["EXERCISE","LIFESTYLE","READING","STUDY","LANGUAGE","HOBBY","MONEY","CAREER"]), instance: data_patchInterestingCategories.self)
//    { result in
//        switch result {
